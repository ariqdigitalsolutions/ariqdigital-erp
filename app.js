...
const defaultData = {
  settings:{
    companyName:'General Business ERP Demo', phone:'+263 77 000 0000', address:'Bulawayo, Zimbabwe', invoiceFooter:'Thank you for your business.',
  ...
  users:[
    {id:1,name:'Admin User',email:'admin@business.erp',password:'123456',role:'Admin / Owner',active:true},
    {id:2,name:'Supervisor',email:'supervisor@business.erp',password:'123456',role:'Supervisor',active:true},
    {id:3,name:'Accountant',email:'accountant@business.erp',password:'123456',role:'Accountant',active:true},
    {id:4,name:'Cashier',email:'cashier@business.erp',password:'123456',role:'Cashier / Sales Clerk',active:true}
  ],
  products:[
...
let state = load();
let session = JSON.parse(localStorage.getItem('businessERP.session') || 'null');
...
function resetDemo(){ if(confirm('Reset all demo data?')){ localStorage.removeItem(ERP_KEY); localStorage.removeItem('businessERP.session'); session=null; state=load(); render(); } }
...
/* --------------------------------------------------------------------------
   ...
   These functions preserve the General Business ERP business logic while adding
